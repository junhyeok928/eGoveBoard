...
<body onLoad="fn_egov_init();">
	...
	<!-- 상단타이틀 -->
	<form:form commandName="articleVO" action="${pageContext.request.contextPath}/user/cop/bbs/updateBoard.do" method="post" onSubmit="fn_egov_updt_article(document.forms[0]); return false;" enctype="multipart/form-data">
		<div class="wTableFrm">
