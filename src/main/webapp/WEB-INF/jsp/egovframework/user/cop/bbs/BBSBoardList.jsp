		...
		<ul>
			...
			<li>
				...
				<c:if test="${preview != 'true'}">
					<span class="btn_b"><a href="<c:url value='/cop/bbs/insertArticleView.do' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span><!-- 등록 -->
				</c:if>
			</li>
		</ul>
	</div>
